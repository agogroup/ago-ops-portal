...
4. **bolt.new用プロンプト作成**
   - `docs/bolt-prompt.md` にプロトタイプ生成用プロンプトを用意
...
1. **bolt.new でタイムチャートのプロトタイプ生成**
   - `docs/bolt-prompt.md` のプロンプトを使用
   - https://bolt.new にアクセスしてコード生成
...
├── mockups.md        ← 画面モックアップ
└── bolt-prompt.md    ← プロトタイプ生成用プロンプト
```

### 技術選定

- **開発方法**: AI駆動開発（bolt.new）
